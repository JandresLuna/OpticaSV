  ...
  const services: ServiceItem[] = [
    {
      ...
      icon: <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"/><path d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z"/></svg>
    },
    {
      id: '02',
      ...
      icon: <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path d="M7 21a4 4 0 01-4-4V5a2 2 0 012-2h4a2 2 0 012 2v12a4 4 0 01-4 4zm0 0h12a2 2 0 002-2v-4a2 2 0 00-2-2h-2.343M11 7.343l1.657-1.657a2 2 0 012.828 0l2.829 2.829a2 2 0 010 2.828l-8.486 8.485M7 17h.01"/></svg>
    },
    {
      id: '03',
      ...
      icon: <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z"/></svg>
    },
    {
      id: '04',
      title: 'Lentes de Contacto',
      description: 'Adaptación profesional y seguimiento para una comodidad visual absoluta en tu día a día.',
      icon: <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path d="M12 3v1m0 16v1m9-9h-1M4 12H3m15.364 6.364l-.707-.707M6.343 6.343l-.707-.707m12.728 0l-.707.707M6.343 17.657l-.707.707M16 12a4 4 0 11-8 0 4 4 0 018 0z"/></svg>
    }
  ];
      ...
      <section id="metodo" className="py-32 bg-white">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-4 gap-4">
            {[
              { n: '01', t: 'Escucha Activa', d: 'Analizamos tu rutina y rasgos para entender qué buscas proyectar.' },
              { n: '02', t: 'Examen Digital', d: 'Precisión computarizada de vanguardia para una salud ocular óptima.' },
              { n: '03', t: 'Asesoría de Imagen', d: 'Curaduría experta de monturas basada en visagismo y tendencias.' },
              { n: '04', t: 'Ajuste & Entrega', d: 'Personalización técnica milimétrica para un confort total.' }
            ].map((step, i) => (
              <div key={i} className="reveal group p-12 border border-transparent hover:bg-gray-50 transition-all rounded-[3rem] [transition-delay:calc(0.1s*var(--i))]">
                <span className="font-mono text-5xl font-light text-gray-100 group-hover:text-brand-blue transition-colors block mb-10">{step.n}</span>
      ...
      <section id="servicios" className="py-40 bg-gray-50 relative overflow-hidden">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {services.map((s, i) => (
              <div key={s.id} className="reveal bg-white p-12 rounded-[3rem] titanium-border group hover:-translate-y-2 transition-transform duration-500 shadow-sm hover:shadow-2xl hover:shadow-blue-900/5 [transition-delay:calc(0.1s*var(--i))]">
                <div className="w-14 h-14 mb-10 bg-brand-blue text-white rounded-2xl flex items-center justify-center shadow-xl group-hover:scale-110 transition-transform">
                  {s.icon}
                </div>
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          <div className="grid lg:grid-cols-2 gap-32 items-center">
            ...
            <div className="reveal [transition-delay:0.3s]">
              <div className="aspect-square bg-white/5 rounded-[4rem] p-1 border border-white/10 flex items-center justify-center relative overflow-hidden">
                ...
                <div className="text-center relative z-10 p-12">
                  <div className="w-24 h-24 bg-white text-brand-blue rounded-3xl flex items-center justify-center mx-auto mb-10 animate-pulse shadow-2xl">
                    <svg className="w-10 h-10" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M9.663 17h4.673M12 3v1m6.364 1.636l-.707.707M21 12h-1M4 12H3m3.343-5.657l-.707-.707m2.828 9.9a5 5 0 117.072 0l-.548.547A3.374 3.374 0 0014 18.469V19a2 2 0 11-4 0v-.531c0-.895-.356-1.754-.988-2.386l-.548-.547z" /></svg>
                  </div>
                  <p className="text-3xl font-serif italic text-white/90 leading-snug">"Diseñamos una mirada que hable de ti."</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-32 items-center">
            ...
            <div className="reveal [transition-delay:0.5s] hidden lg:block">
              <div className="relative">
                <div className="w-full aspect-[4/5] bg-gray-50 rounded-[4rem] overflow-hidden titanium-border">
                  <img src="https://images.unsplash.com/photo-1511499767350-a1590fdb2863?q=80&w=2000&auto=format&fit=crop" alt="Salud Visual" className="w-full h-full object-cover grayscale opacity-80" />
                </div>
                <div className="absolute -top-10 -right-10 w-48 h-48 bg-brand-blue rounded-full flex items-center justify-center border-[12px] border-white shadow-2xl">
      ...
      <section id="contacto" className="py-40 bg-gray-50">
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid lg:grid-cols-2 gap-24 items-center">
            ...
            <div className="reveal [transition-delay:0.3s]">
              <div className="w-full aspect-square rounded-[4rem] overflow-hidden border-[20px] border-white shadow-2xl relative">
                <div className="w-full h-full bg-[#f3f4f6] flex items-center justify-center overflow-hidden">
                   <div className="absolute inset-0 prism-grid opacity-40"></div>
                   <div className="relative text-center">
                     <div className="w-20 h-20 bg-brand-blue rounded-3xl flex items-center justify-center mx-auto mb-8 animate-bounce shadow-2xl">
                       <div className="w-5 h-5 bg-white rounded-full"></div>
                     </div>
                     <p className="text-sm font-bold uppercase tracking-[0.2em] text-[#121212]">S&V Suba</p>
                     <p className="text-[10px] text-gray-400 uppercase mt-3 tracking-widest">Frente a la Plaza Central</p>
                   </div>
                </div>
              </div>
            </div>
